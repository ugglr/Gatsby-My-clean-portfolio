...
export const workExperience = [
  ...
  },
  {
    ...
    company: {
      ...
      url:
        "https://baike.baidu.com/item/%E7%A9%86%E5%A4%A9%E6%9C%BA%E5%99%A8%E4%BA%BA%EF%BC%88%E6%9D%AD%E5%B7%9E%EF%BC%89%E6%9C%89%E9%99%90%E5%85%AC%E5%8F%B8/22643399?fr=aladdin",
    },
    present: false,
    startYear: "2019",
    startMonth: "05",
    ...
    endMonth: "07",
    description: `
        Robotics startup making a wide range of robots from public service robots to educational robots for children.
        
        • Develop robot power management, motor drive, ARM micro-controller control system hardware;
        • Complete the device selection, schematic diagram, PCB Layout design;
        • Submit BOM form, make purchase request and prepare hardware documentation;
        • Responsible for hardware debugging and testing, team collaboration to meet product planning;
  ...
  },
  {
    ...
    endMonth: "01",
    description: `
    • Designed analog & digital electronic circuits for Network/IP-Surveillance Cameras.
    • Hardware QA: Signal Integrity, system robustness, thermal evaluation etc.
    • Regulatory complience & Electrical Magnetic Compability testing (EMC): CE, UL, FCC, TUV, KCC, Rolling Stock.
    • Product Lifecycle Management (PLM: Windchill) Super User, future feature group & Tech. support.
    • Component sourcing
    `,
    projects: [],
  },
  ...
  },
  {
    ...
    endYear: "2012",
    endMonth: "08",
    description: `Prototype development & Embedded Linux programming. UX/UI Study of touchscreen applications for kitchen appliances.`,
  },
]
